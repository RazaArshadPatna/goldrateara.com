            ...
            <section class="content">
                ...
                <div class="row">
                        ...
                        <div class="box">
                            ...
                            <div class="box-header">
                                ...
                                <div class="pull-right">
                                    ...
                                    <button class="btn bg-red-gradient btn-flat " onclick="Trush('additems')"><i class="fa fa-trash-o"></i></button>
                 ...
                 $i=1;
                  ...
                  $sql="SELECT `id`, `name`, `entry_time`, `entry_by` FROM `additems`";

                 $s=$conn->prepare($sql);

                 $s->bind_result($id,$name,$entry_time,$entry_by);
                 ...
                 ?>
                                            ...
                                            <tr id="row<?php echo $id; ?>">
                                               ...
                                               <td><input type="checkbox" name="mycheck" value="<?php  echo $id; ?>" /></td>
                                                ...
                                                <td><a href="add.php?id=<?php echo $id; ?>"><button

...
$image=$status=$entry_by=$entry_time="";
...
if(isset($_GET['id'])){
     ...
     $sql="SELECT `id`, `image`, `status`, `entry_by`, `entry_time` FROM `image_gallery` WHERE id=?";

     $s=$conn->prepare($sql);

     $s->bind_param("s",$id);

     $s->bind_result($edit_id,$image1,$status,$entry_by,$entry_time);
                        ...
                        <div class="box box-primary">
                            ...
                            <div class="box-header with-border">
                                ...
                                <div class="pull-right">
                                    ...
                                    <a href="image-gallery.php"><button class="btn bg-green-gradient btn-flat "><i
                            ...
                            <form id="myForm" role="form" enctype='multipart/form-data'
                                action="action/image-gallery.php" method="post">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group col-xs-12">
                                        ...
                                        <div class="form-group col-xs-12">
                                            ...
                                            <input type="file" class="form-control" name="logo_70" id="logo_70">
                                            <!--<span style="color:red;">*(Choose 1920x1080 size for image)</span>-->
                                        ...
                                        <div class="form-group col-xs-12">
                                            ...
                                            <img height="70" width="70" src="../upload/gallery/<?php echo $image1; ?>" />

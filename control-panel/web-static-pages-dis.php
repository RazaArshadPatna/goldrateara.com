            ...
            <section class="content">
                ...
                <div class="row">
                 ...
                 $i=1;
                  ...
                  $sql="SELECT `id`, `page_menu`, `content`, `entry_time`, `entry_by` FROM `static_page`";

                 $s=$conn->prepare($sql);

                 $s->bind_result($id,$page_menu,$content,$entry_time,$entry_by);
                 ...
                 ?>
                                            ...
                                            <tr id="row<?php echo $id; ?>">
                                                ...
                                                <td><?php echo $page_menu; ?></td>

                                                <td><?php echo CusDate($entry_time); ?></td>

                                                <td><a href="web-static-pages.php?id=<?php echo $id; ?>"><button

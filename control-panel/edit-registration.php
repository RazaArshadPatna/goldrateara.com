...
$mess='';
    ...
    $auto_Fill=true;    
    $id=$_SESSION['id_mart_admin'];
    $sql="SELECT `user_id`,`sponser`,`introducer`,`position`,`member_name`,`password`,`mobile`,`gender`,`dob`,`father`,`email`,`educational`,`address`,`pin`,`nominee`,`relation`,`occupation`,`bank_name`,`bank_branch`,`pan`,`account_no`,`ifsc`,`accept`,`image`,`nationality`,`doj` FROM `registration` WHERE user_id=?";
     $s=$conn->prepare($sql);
     $s->bind_param("s",$id);
     $s->bind_result($uid,$sponser,$introducer,$position,$member_name,$password,$mobile,$gender,$dob,$father,$email,$educational,$address,$pin,$nominee,$relation,$occupation,$bank_name,$bank_branch,$pan,$account_no,$ifsc,$accept,$image,$nationality,$doj);
     if($s->execute()){                    
        $s->fetch();
		$s->close();
	}
              ...
              <div class="box-body">
				...
				<div class="form-group col-xs-5">
				 ...
				 <div class="form-group col-xs-12">
                  ...
                  <input type="text" class="form-control sdata" id="member_name" name="member_name" value="<?php echo $member_name;?>" required readonly>
                </div>
				...
				<div class="form-group col-xs-12">
                  ...
                  <input type="text" class="form-control sdata" id="father" name="father" value="<?php echo $father;?>" required readonly>
                </div>
				
				<div class="form-group col-xs-12">
                  <label for="exampleInputEmail1">Date Of Birth <span class="required">*</span><span class="label label-danger" id="dob_mess"></span></label>
                  <input type="text" class="form-control sdata" id="dob" name="dob" value="<?php if($dob!==0000-00-00) echo date('d/m/Y',strtotime($dob));?>" required readonly>
                </div>
				...
				<div class="form-group col-xs-12">
				 ...
				 <div class="form-group col-xs-12">
                  ...
                  <input type="text" class="form-control sdata" id="bank_name" name="bank_name" value="<?php echo $bank_name;?>" readonly>
                </div>
				
				 <div class="form-group col-xs-12">
                  <label for="exampleInputEmail1">Bank Branch<span class="label label-danger" id="bank_branch_mess"></span></label>
                  <input type="text" class="form-control sdata" id="bank_branch" name="bank_branch" value="<?php echo $bank_branch;?>" readonly>
                </div>
				 ...
				 <div class="form-group col-xs-12">
                  ...
                  <input type="text" class="form-control sdata" id="account_no" name="account_no" value="<?php echo $account_no;?>" readonly >
                </div>
				
				 <div class="form-group col-xs-12">
                  <label for="exampleInputEmail1">IFSC Code<span class="label label-danger" id="ifsc_mess"></span></label>
                  <input type="text" class="form-control sdata" id="ifsc" name="ifsc" value="<?php echo $ifsc;?>" readonly >
				</div>
				
				<div class="form-group col-xs-12">
                  <label for="exampleInputEmail1">Pan Card No<span class="label label-danger" id="pan_mess"></span></label>
                  <input type="text" class="form-control sdata" id="pan" name="pan" value="<?php echo $pan;?>" readonly >
                </div>

          ...
          <div class="box">
            ...
            <div class="box-header">
              ...
              <div class="pull-right">
                  ...
                  <a href="image-gallery-add.php"><button class="btn bg-green-gradient btn-flat margin-r-5"><i class="fa fa-plus-circle"></i></button></a>

                  <button class="btn bg-red-gradient btn-flat" onClick="Trush('image_gallery')"><i class="fa fa-trash-o"></i></button>
          ...
          <div class="table-responsive">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody id="result">
                 ...
                 $sql="SELECT `id`, `image`, `status`, `entry_by`, `entry_time` FROM `image_gallery`";
                ...
                <tr id="row<?php echo $id; ?>">
                    ...
                    <td><a href="image-gallery-add.php?id=<?php echo $id; ?>"><button class="btn bg-primary btn-flat"><i class="fa fa-pencil-square-o"></i></button></a></td>

                   <td><img style="height: 100px;width: 100px" src="../upload/gallery/<?php echo $image; ?>" /></td>

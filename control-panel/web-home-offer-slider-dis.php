          ...
          <div class="box">
            ...
            <div class="box-header">
              ...
              <div class="pull-right">
                  ...
                  <a href="offer-slider.php"><button class="btn bg-green-gradient btn-flat margin-r-5"><i class="fa fa-plus-circle"></i></button></a>

                  <button class="btn bg-red-gradient btn-flat" onClick="Trush('offer')"><i class="fa fa-trash-o"></i></button>
          ...
          <div class="table-responsive">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody id="result">
                 ...
                 $sql="SELECT `id`, `image`, `status`, `entry_by`, `entry_time` FROM `offer`";
                ...
                <tr id="row<?php echo $id; ?>">
                    ...
                    <td><a href="offer-slider.php?id=<?php echo $id; ?>"><button class="btn bg-primary btn-flat"><i class="fa fa-pencil-square-o"></i></button></a></td>

                   <td><img style="height: 100px;width: 100px" src="../upload/banner/<?php echo $image; ?>" /></td>

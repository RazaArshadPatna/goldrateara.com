            ...
            <section class="content">
                ...
                <div class="row">
                 ...
                 $i=1;
                  ...
                  $sql="SELECT `id`, `rate`, `making`, `entry_time`, `entry_by` FROM `calculator`";

                 $s=$conn->prepare($sql);

                 $s->bind_result($id,$rate,$making,$entry_time,$entry_by);
                 ...
                 ?>
                                            ...
                                            <tr id="row<?php echo $id; ?>">
                                                ...
                                                <td><a href="calculator.php?id=<?php echo $id; ?>"><button

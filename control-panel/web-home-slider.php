...
if(isset($_GET['id'])){
     ...
     $sql="SELECT `id`, `image`, `status`, `entry_by`, `entry_time` FROM `banner` WHERE id=?";
                        ...
                        <div class="box box-primary">
                            ...
                            <div class="box-header with-border">
                                ...
                                <div class="pull-right">
                                    ...
                                    <a href="web-home-slider-dis.php"><button class="btn bg-green-gradient btn-flat "><i
                            ...
                            <form id="myForm" role="form" enctype='multipart/form-data'
                                action="action/web-home-slider.php" method="post">
                                    ...
                                    <div class="form-group col-xs-12">
                                        ...
                                        <div class="form-group col-xs-12">
                                            ...
                                            <input type="file" class="form-control" name="logo_70" id="logo_70"><span
                                                style="color:red;">*(Choose 1553x380 size for image)</span>
                                        ...
                                        <div class="form-group col-xs-12">
                                            ...
                                            <img height="70" width="70" src="../upload/slider/<?php echo $image1; ?>" />

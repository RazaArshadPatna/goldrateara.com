          ...
          <div class="box">
            ...
            <div class="box-header">
              ...
              <div class="pull-right">
                  ...
                  <!-- <a href="category-add.php"><button class="btn bg-green-gradient btn-flat margin-r-5"><i class="fa fa-plus-circle"></i></button></a> -->
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody id="result">
                 ...
                 $i=1;
                  ...
                  $sql="SELECT `id`,`Name`,`mobile`,`Email`,`Details`,`entry_time` FROM `contact_us` WHERE 1 order by `id` desc";

                 $s=$conn->prepare($sql);

                 $s->bind_result($id,$name,$mobile,$email,$details,$entry_time);
